...
+ Выполните команду `yarn docker:dev` чтобы запустить образы (`Server` и `pgAdmin`), а также запустить `server` (не образ)
+ Выполните команду `yarn docker:stop` чтобы отсановить образы
